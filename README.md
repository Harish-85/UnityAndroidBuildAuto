...
4.Populate the build_config files with the necessary info
  i-UNITY_PATH refers to your editor executable path. MacOs might require you to append "Unity.app/Content/MacOS/Unity" ie it will be something like this
  > /Applications/Unity/Hub/Editor/<UNITY_VERSION>/Unity.app/Contents/MacOS/Unity
  ii. REPO_URL - I recomend using ssh and make sure you are authenticaed to run git clone
  iii. GP_SERVICE - Refer the [Fastlane docs' ](https://docs.fastlane.tools/getting-started/android/setup/) ,Collect Your credentials' section to get the gpservice.json file
  iv. DISCORD_HOOK can be obtained by going to your Discord Server Settings -> Integrations -> Webhooks and creating a new one
  v. PACKAGE_NAME - your unity package name , same as the one from google play console
  vi. BRANCH_NAME - The name of the branch you want to poll for changes
